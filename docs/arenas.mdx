...
<Image src={grafoGephi} alt="Vista del grafo de conocimiento" width={1000} data-reveal class={"rounded-4xl w-full bg-muted my-20!"} />
...
<Image src={grafoNoFotos} alt="Grafo con capas de metadatos activas" width={1000} data-reveal class={"rounded-4xl w-full bg-muted my-20!"} />
...
<Image src={thumbnail2} alt="Panel lateral contextual con detalles del TFM" width={1000} data-reveal class={"rounded-4xl w-full bg-muted my-20!"} />
